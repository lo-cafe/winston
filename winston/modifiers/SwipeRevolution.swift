...
struct SwipeRevolution<Content: View, T: GenericRedditEntityDataType, B: Hashable>: View, Equatable {
  static func == (lhs: SwipeRevolution<Content, T, B>, rhs: SwipeRevolution<Content, T, B>) -> Bool {
...
//  }
  ...
  var body: some View {
    if let entity = entity {
      ...
      GesturerHolder(id: entity.id, size: size, directions: .horizontal, onTap: nil, onDragChanged: { cancel, translation, location, velocity in
...
//        }
      ...
      }, disabled: false, content: { controller in
