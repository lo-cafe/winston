...
extension Defaults.Keys {
    ...
    static let customIndentationThemes = Key<Dictionary<String,[String]>>("customIndentationThemes", default: [
        "Monochrome": [Color("divider").toHex()],
        "Rainbow":    [Color(hex: 0xF44236), Color(hex: 0xFE922D), Color(hex: 0x2C704B), Color(hex: 0x0D73DC), Color(hex: 0x653996)].colorsToHexStrings(),
        "IBM":       [Color(hex: 0x648FFF), Color(hex: 0x785EF0), Color(hex: 0xDC267F), Color(hex: 0xFE6100), Color(hex: 0xFFB000)].colorsToHexStrings(),
        "Fire":       [Color(hex: 0xFF0000), Color(hex: 0xD40000), Color(hex: 0xCF5B00), Color(hex: 0xcFF7C00), Color(hex: 0xF0A208)]
            .colorsToHexStrings(),
        "Forest":       [Color(hex: 0x275036), Color(hex: 0x55713B), Color(hex: 0x318F28), Color(hex: 0x98CB6D), Color(hex: 0xA8BF65)].colorsToHexStrings(),
        "Ocean":       [Color(hex: 0x0370C2), Color(hex: 0x0190FB), Color(hex: 0x00C3FA), Color(hex: 0x0090FC), Color(hex: 0x23A0FF)].colorsToHexStrings()
    ])
}
