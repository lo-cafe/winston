...
struct GeneralPanel: View {
  ...
  @Default(.useReaderMode) var useReaderMode
  @Default(.useBuiltInBrowser) var useBuiltInBrowser
  ...
  var body: some View {
    List{
      ...
      Section("Safari"){
        Toggle("Use Built-In Browser", isOn: $useBuiltInBrowser)
        Toggle("Always Use Reader Mode", isOn: $useReaderMode)
      }
      Section("Advanced"){
        ...
        Button {
          ...
          Label("Reset preferences", systemImage: "clock.arrow.circlepath")
            .foregroundColor(.red)
        }
