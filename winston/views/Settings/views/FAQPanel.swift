  ...
  var body: some View {
    ...
    VStack{
      List{
        ...
        QuestionAnswer(question: "Will Winston be released in the App Store at some point?", answer: "Yes. Reddit is planned to be released in the App Store soon, still allowing users to use their own API key.", systemImage: "safari")
